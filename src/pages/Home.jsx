...
import resume from '../assets/img/bhuvaneshwaran_resume.png';
...
export const Home = () => {
        ...
        <div className="w-full md:w-[50%] flex flex-col items-center justify-center">
          ...
          <div className="w-[85%] p-5 md:p-10 m-5 md:m-10 rounded-lg bg-slate-800 bg-opacity-80 backdrop-blur-lg">
            <p className="text-white font-extralight text-sm md:text-base">
              I'm Bhuvaneshwaran, currently pursuing my B.Tech in Information Technology at Sri Shakthi Institute of Engineering
  ...
  <div className="mt-6">
    <h4 className="text-lg mb-4">My Resume</h4>
    <img src={resume} alt="Resume" className="mx-auto w-3/4 md:w-1/2 border-2 border-gray-400 rounded-lg shadow-lg" />
  </div>
  <p className="mt-4 text-sm">&copy; 2024 Bhuvaneshwaran. All rights reserved.<br /><p>Made with ❤ by Bhuvi</p></p>
</footer>
